...
import { Table, Button, Tab, Modal, Form, Row, Col, Nav } from "react-bootstrap";
...
const Profile = (props) => {
  ...
  const customers = [
    { id: "#20462", name: "ABC", dietary: "Vegetarian", orders: 3, company: "Company A", business: "Business A", email: "abc@example.com", phone: "123456789", address: "123 ABC Street", loyaltyPoints: 50 },
    { id: "#18933", name: "DEF", dietary: "Gluten-Free", orders: 5, company: "Company B", business: "Business B", email: "def@example.com", phone: "987654321", address: "456 DEF Street", loyaltyPoints: 75 },
    { id: "#45169", name: "GHI", dietary: "None", orders: 10, company: "Company C", business: "Business C", email: "ghi@example.com", phone: "456789123", address: "789 GHI Street", loyaltyPoints: 25 },
    { id: "#34304", name: "JKL", dietary: "Vegan", orders: 7, company: "Company D", business: "Business D", email: "jkl@example.com", phone: "321654987", address: "321 JKL Street", loyaltyPoints: 100 },
    { id: "#17188", name: "MNO", dietary: "Gluten-Free", orders: 14, company: "Company E", business: "Business E", email: "mno@example.com", phone: "159753456", address: "456 MNO Street", loyaltyPoints: 60 },
    { id: "#73003", name: "PQR", dietary: "Vegetarian", orders: 15, company: "Company F", business: "Business F", email: "pqr@example.com", phone: "753159852", address: "789 PQR Street", loyaltyPoints: 30 },
  ];

  const orders = [
    { id: "#20462", payment: "PayPal", status: "Completed", total: 378.9, deliveryDate: "October 3, 2024", products: [
        { name: "Mini Mezze", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit.", price: 13.5, quantity: 8 },
        { name: "Mini Mezze", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit.", price: 38.2, quantity: 3 },
      ]
    },
    { id: "#18933", payment: "Credit Card", status: "Completed", total: 562.03, deliveryDate: "October 2, 2024", products: [] },
    { id: "#45169", payment: "Cash", status: "Pending", total: 609.9, deliveryDate: "October 1, 2024", products: [] },
    { id: "#34304", payment: "PayPal", status: "Pending", total: 863.8, deliveryDate: "September 30, 2024", products: [] },
    { id: "#17188", payment: "PayPal", status: "Cancelled", total: 873.8, deliveryDate: "September 29, 2024", products: [] },
  ];
    ...
    <Tab.Pane {...props}>
      ...
      <div className="crm-container">
        <div className="d-flex justify-content-between align-items-center mb-4">
          ...
          <Button variant="primary" className="add-btn">Add Customer</Button>
        </div>
          ...
          <tbody>
            {customers.map((customer) => (
              <tr key={customer.id}>
                <td>{customer.id}</td>
                <td>
                  <AccountCircleIcon className="customer-icon" /> {customer.name}
                </td>
                <td>
        ...
        <Row className="mb-3">
          ...
          <Col md={6}>
            <Form.Group>
              ...
              <Form.Control type="text" value={customer.loyaltyPoints} readOnly />
            </Form.Group>
          </Col>
        </Row>
        <Row className="mb-3">
...
const OrderHistoryModal = ({ show, onHide, customerId, orderHistory, onViewDetails }) => {
      ...
      <Modal.Body>
        <Tab.Container activeKey={activeTab} onSelect={handleTabChange}>
              ...
              <Nav variant="pills">
                ...
                <Nav.Item>
                  <Nav.Link eventKey="pending">
                    Pending ({orderHistory.filter((order) => order.status === "Pending").length})
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey="completed">
                    Completed ({orderHistory.filter((order) => order.status === "Completed").length})
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item>
          ...
          <Row className="mb-3 align-items-center">
            <Col md={5}>
              <Form.Control type="text" placeholder="Search for id, name, email, etc." />
            </Col>
            <Col md={3}>
            ...
            <tbody>
              {filteredOrders.map((order) => (
                <tr key={order.id}>
                  ...
                  <td>${order.total}</td>
                  <td>
                    <Button variant="info" className="view-btn" onClick={() => onViewDetails(order)}>
                      View
                    </Button>
                  </td>
                </tr>
