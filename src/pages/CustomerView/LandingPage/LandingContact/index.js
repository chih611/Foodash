        ...
        <Row className="justify-content-between">
          ...
          <Col xs={12} md={3} className="justify-content-center m-3 text-right">
            ...
            <p>
              Working Hours:
              <p>
                We open from 9:00 to 17:00<p>Monday to Friday</p>
              </p>
            </p>
            <p>
              Deliver between 8am to 3pm
              <p>within 5km incur a flat rate of $25</p>
            </p>
            <p>
              Pick up is available between
              <p>7:30am and 3pm, Monday to Friday</p>
            </p>
          </Col>
          <Col xs={12} md={4} className="m-3 text-right">
            ...
            <p>
              Building A: <p> Pacific Epping, Cooper Sts, Epping</p>
            </p>
            <p>
              Building B: <p>Melbourne Polytechnic, Cnr Dalton Rd</p>{" "}
            </p>
          </Col>
